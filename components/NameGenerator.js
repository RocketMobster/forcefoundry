    ...
    <div className="min-w-md max-w-lg mx-auto w-full px-2 py-2">
      ...
      <div className="flex mb-8 justify-center gap-4">
        <button
          ...
          className={`bg-green-600 hover:bg-green-700 ${deviceClasses?.primaryButtonSize || 'px-6 py-4 text-sm'} rounded-lg font-semibold flex items-center gap-2 transition-all ${deviceClasses?.touchTarget || ''}`}
        >
          <span>⚡</span>
          Generate Names
        </button>
        <button
          ...
          className={`bg-yellow-600 hover:bg-yellow-700 ${deviceClasses?.primaryButtonSize || 'px-6 py-4 text-sm'} rounded-lg font-semibold flex items-center gap-2 transition-all ${deviceClasses?.touchTarget || ''}`}
        >
          <span>⭐</span>
                ...
                {favorites.length > 0 && (
                  <>
                    <button
                      ...
                      className={`bg-blue-600 hover:bg-blue-700 ${deviceClasses?.navButtonSize || 'px-4 py-3 text-sm'} rounded ${deviceClasses?.touchTarget || ''}`}
                    ...
                    <button
                      ...
                      className={`bg-red-600 hover:bg-red-700 ${deviceClasses?.navButtonSize || 'px-4 py-3 text-sm'} rounded ${deviceClasses?.touchTarget || ''}`}
                    >
                      Clear All
                    </button>
                  </>
